...
export default async function handler(req, res) {
    ...
    try {
        // Use top 2 artists and top 3 tracks from their library as seeds for better recommendations
        ...
        const recommendationsResponse = await fetch(`https://api.spotify.com/v1/recommendations?limit=12&seed_artists=${seed_artists}&seed_tracks=${seed_tracks}`, {
        ...
        res.status(200).json({ recommendations: recommendations.tracks });
